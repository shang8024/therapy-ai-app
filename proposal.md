# Therapy AI - Proposal
* Jingxian Hou: 100159710
* Jiale Shang: 1006580022
* Patrick Chamaa: 1012574233
* Gaurav Kashyap: 1003971053 
## Motivation

Have you ever wanted to talk to someone, not a friend or a doctor, just a calm and understanding listener, but found that help was hard to reach, too formal, or locked behind long waitlists and paywalls?

Many people experience moments of stress, anxiety, or loneliness where they just want to be heard and gently guided toward healthier thinking. Yet most mental health apps today are either clinical in tone, overloaded with features, or require heavy data sharing that makes users uneasy.
...
* On-device JavaScript keyword detection triggers immediate crisis resource modal from local JSON file (sub-3 second response, no network required).
* High-risk messages optionally flagged in backend for pattern review.
...
1.  **User Authentication (Phase 2 - Stretch Goal)**
...
2.  **Real-Time Updates (Core to MVP)**
