...
export const DashboardProvider: React.FC<Props> = ({ children }) => {
  ...
  const [moodTrend7Days, setMoodTrend7Days] = useState<MoodTrendData | null>(null);
  const [moodTrend30Days, setMoodTrend30Days] = useState<MoodTrendData | null>(null);
  const [loading, setLoading] = useState<boolean>(true);
  const [error, setError] = useState<string | null>(null);
  const [selectedTimeRange, setSelectedTimeRange] = useState<'7days' | '30days'>('7days');
